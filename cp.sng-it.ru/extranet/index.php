...
$APPLICATION->SetPageProperty("title", htmlspecialcharsbx(COption::GetOptionString("main", "site_name", "Экстранет")));
?>
<?
$APPLICATION->IncludeComponent("bitrix:socialnetwork_user", ".default", Array(
	...
	"CALENDAR_SUPERPOSE_GROUPS_IBLOCK_ID" => "0",
...
if(CModule::IncludeModule('calendar')):
	$APPLICATION->IncludeComponent("bitrix:calendar.events.list", "widget", array(
		...
		"DETAIL_URL" => "/extranet/contacts/personal/user/#user_id#/calendar/",
		"EVENTS_COUNT" => "10",
		"CACHE_TYPE" => "N",
		"CACHE_TIME" => "3600"
		),
